    ...
    return html`
      ...
      <body>
        ...
        <div style="width:300px; height:180px; position:absolute; top:0px; left:600px; padding:0px 20px;" >
          ...
          <filter-manager id="filterManager"
                          type-manager="[[typeManager]]"
                          style="padding:0px 0px 20px;"></filter-manager>
        </div><!-- END OF FILTERS -->
        ...
        <div>
          <paper-dialog id="searchResultsDialog" style=" height:450px; width:800px; ">
            ...
            <p>
              Results of {{searchCategory}} Search on server {{serverName}}
              using expression \"{{searchText}}\"
            </p>
            ...
            <div id="containerForSearchResults"></div>
