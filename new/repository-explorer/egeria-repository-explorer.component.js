...
/**
 *
 * EgeriaRepositoryExplorer is the top level web component for the Repository Explorer UI component.
...
class EgeriaRepositoryExplorer extends mixinBehaviors([AppLocalizeBehavior], PolymerElement) {
    static get template() {
        return html`
...
window.customElements.define('egeria-repository-explorer', EgeriaRepositoryExplorer);